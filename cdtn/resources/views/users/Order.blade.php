                                ...
                                @isset($shopping_carts)
                                    @foreach ($shopping_carts as $shopping_cart)
                                        <tr class="ms-tr">
                                            ...
                                            <td class="ms-td">
                                                <div><span
                                                        class="total-price">{{ number_format($shopping_cart->price, 0, ',', '.') }}
                                                        đ</span>
                                                </div>
                                            </td>
                                            <td class="ms-td">
                                ...
                                @isset($cart_detail, $products)
                                    @foreach ($products as $product)
                                        <tr class="ms-tr">
                                            ...
                                            <td class="ms-td">
                                                <div><span class="total-price">{{ number_format($product->price, 0, ',', '.') }}
                                                        đ</span>
                                                </div>
                                            </td>
                                            <td class="ms-td">
                    ...
                    <div class="order-right-price d-flex w-100 pt-4">
                        ...
                        <div class="flex-1">
                            <span class="total_price">
                                @isset($total_price)
                                    {{ number_format($total_price[0]->total_price, 0, ',', '.') }} đ
                                @endisset
                            </span>
                        </div>
                    </div>
