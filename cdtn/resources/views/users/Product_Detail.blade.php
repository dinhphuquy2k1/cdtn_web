        ...
        <div class="product-detail-wrapper">
            <div class="product-detail-header">
                <div class="pd-header-left d-flex flex-column">
                    ...
                    {{-- <div class="pd-header-left-detail d-flex flex-row">
                        <div class="item-left-detail flex-1 d-flex justify-content-center">
                            <img src="{{ asset('assets/images/image 68.png') }}" alt="">
                        </div>
                        <div class="item-left-detail flex-1 d-flex justify-content-center">
                            <img src="{{ asset('assets/images/image 69.png') }}" alt="">
                        </div>
                        <div class="item-left-detail flex-1 d-flex justify-content-center">
                            <img src="{{ asset('assets/images/image 70.png') }}" alt="">
                        </div>
                        <div class="item-left-detail flex-1 d-flex justify-content-center">
                            <img src="{{ asset('assets/images/image 71.png') }}" alt="">
                        </div>
                    </div> --}}
                </div>
