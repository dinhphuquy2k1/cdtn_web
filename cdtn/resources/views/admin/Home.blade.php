            ...
            <div class="navbar-menu">
                ...
                <a class="item-link sub-btn sub-menu">
                    ...
                    <div class="navbar-menu-child">
                        <div class="sub-menu">
                            <a href="{{ route('manageProductsbyID', 1) }}" class="sub-item">
                                <div>Quản lý iphone</div>
                            </a>
                            <a href="{{ route('manageProductsbyID', 3) }}" class="sub-item">Quản lý Ipad</a>
                        </div>
                    </div>
                </a>
                <a href="{{ route('manageCategory') }}" class="item-link">
                    <div class="navbar-item nav-report">
                        <div class="navbar-item-content">Quản lý loại sản phẩm
                        </div>
                    </div>
                </a>
                <a href="">
